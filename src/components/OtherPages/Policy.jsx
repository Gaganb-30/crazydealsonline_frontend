            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="text-gray-300 leading-relaxed">
                  Welcome to CrazyDealsOnline. We are committed to protecting
                  your privacy and ensuring transparency about how we handle
                  your information. This Privacy Policy explains what
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                  <li>Provide and maintain our book stock</li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                  <li>
                    ...
                    providers like Razorpay for transaction processing
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  personal information, including encryption, secure servers,
