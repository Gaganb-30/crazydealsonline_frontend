...
const Footer = () => {
  ...
  return (
    <div className="w-full">
      <footer className="bg-white border-t border-gray-200 px-4 sm:px-6 lg:px-8  pb-6 pt-8">
        {/* Main Footer Content */}
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-6 lg:mb-8">
            ...
            <div className="text-center md:text-left">
              <h4 className="font-bold text-navy mb-4 text-lg sm:text-xl">
                Company
              </h4>
          ...
          {/* Bottom Section */}
          <div className="border-t border-gray-200 pt-4 flex flex-col lg:flex-row justify-between items-center gap-6">
